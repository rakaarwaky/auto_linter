...
- mcp_job_management.py - check_status, cancel_job
...
def register_tools(mcp: FastMCP, container: Container):
    ...
    5. cancel_job - Job cancellation
    6. health_check - DesktopCommander health
    """
    ...
    from surfaces.mcp_job_management import register_check_status, register_cancel_job
